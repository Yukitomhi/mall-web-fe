<template>
  <div class="app-container">
    <el-card class="operate-container" shadow="never">
      ...
      <span style="margin-top: 5px">Product List</span>
      <el-button
        class="btn-add"
    ...
    <div class="table-container">
      <el-table ref="productCateTable"
        ...
        <el-table-column label="Product Quantity" width="100" align="center">
        ...
        <!--  </template>-->
        <!--</el-table-column>-->
        <!--<el-table-column label="Show" width="100" align="center">-->
        <!--  <template slot-scope="scope">-->
        <!--    <el-switch-->
        ...
        <el-table-column label="Settings" width="140" align="center">
          <template slot-scope="scope">
            <el-button
              size="mini"
              :disabled="scope.row.level | disableNextLevel"
              @click="handleShowNextLevel(scope.$index, scope.row)">Subordinates
            </el-button>
            <!--<el-button-->
            <!--  size="mini"-->
