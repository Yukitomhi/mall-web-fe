  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="productAttrCateTable"
        ...
        <el-table-column label="Settings" width="240" align="center">
          <template slot-scope="scope">
            <el-button
              size="mini"
              @click="getAttrList(scope.$index, scope.row)">Attribution
            </el-button>
            <el-button
              size="mini"
  ...
  export default {
    ...
    methods: {
      ...
      addProductAttrCate() {
        ...
        this.dialogTitle = "Add Product Type";
      },
      ...
      handleConfirm(formName){
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(this.dialogTitle==="Add Product Type"){
