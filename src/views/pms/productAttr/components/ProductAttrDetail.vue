    ...
    <el-form :model="productAttr" :rules="rules" ref="productAttrFrom" label-width="150px">
      ...
      <el-form-item label="Search Type:">
        <el-radio-group v-model="productAttr.searchType">
          ...
          <el-radio :label="1">Keyword</el-radio>
          <el-radio :label="2">Range</el-radio>
        </el-radio-group>
      </el-form-item>
      <el-form-item label="Attribute relation:">
      ...
      <el-form-item label="Sort Attribution：">
