<template>
  <div style="margin-top: 50px">
    <el-form :model="value" ref="productSaleForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="Pre-release Product:">
        <el-switch
      ...
      <el-form-item label="Product Publish:">
        <el-switch
      ...
      <el-form-item label="Product Recommendations:">
      ...
      <el-form-item label="Service Guarantee:">
        <el-checkbox-group v-model="selectServiceList">
          <el-checkbox :label="1">No-hassle Returns</el-checkbox>
      ...
      <el-form-item label="Select Promotion Type:">
        <el-radio-group v-model="value.promotionType" size="small">
          ...
          <el-radio-button :label="4">Discount Price</el-radio-button>
        </el-radio-group>
      </el-form-item>
