<template>
  <div style="margin-top: 50px">
    <el-form :model="value" :rules="rules" ref="productInfoForm" label-width="120px" style="width: 600px" size="small">
      ...
      <el-form-item label="Product inventory：">
      ...
      return {
        ...
        rules: {
          name: [
            ...
            {min: 2, max: 140, message: 'Length in 2-140 characters', trigger: 'blur'}
          ],
          subTitle: [{required: true, message: 'Please Input Product Sub Title', trigger: 'blur'}],
          productCategoryId: [{required: true, message: 'Please choose product category', trigger: 'blur'}],
          brandId: [{required: true, message: 'please select product brand', trigger: 'blur'}],
          description: [{required: true, message: 'Please Input Product Introduction', trigger: 'blur'}],
          requiredProp: [{required: true, message: 'Required!', trigger: 'blur'}]
        }
      };
    },
    created() {
