    ...
    <el-form :model="value" ref="productAttrForm" label-width="120px" style="width: 720px" size="small">
      ...
      <el-form-item label="Product Specifications：">
        ...
        <el-button
          ...
          @click="handleRefreshProductSkuList">Fresh
        </el-button>
        <el-button
          type="primary"
          style="margin-top: 20px"
      ...
      <el-form-item label="Pictures：" v-if="hasAttrPic">
        <el-card shadow="never" class="cardBg">
      ...
      <el-form-item label="Specification parameters：">
  ...
  export default {
    ...
    methods: {
      ...
      handleRefreshProductSkuList() {
        this.$confirm('刷新列表将导致sku信息重新生成，是否要刷新', 'Tip', {
      ...
      handleSyncProductSkuPrice(){
        this.$confirm('将同步第一个sku的价格到所有sku,是否继续', 'Tip', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
      ...
      handleSyncProductSkuStock(){
        this.$confirm('将同步第一个sku的库存到所有sku,是否继续', 'Tip', {
          confirmButtonText: 'Confirm',
          cancelButtonText: 'Cancel',
          type: 'warning'
        }).then(() => {
