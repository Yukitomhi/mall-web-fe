<template>
  <div class="app-container">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="total-frame">
            ...
            <div class="total-title">Today Order Count</div>
        ...
        <el-col :span="8">
          <div class="total-frame">
            ...
            <div class="total-title">Today Sales Amount</div>
        ...
        <el-col :span="8">
          <div class="total-frame">
            ...
            <div class="total-title">Yesterday Sales Amount</div>
            <div class="total-value">￥5000.00</div>
          </div>
        </el-col>
        <!--<el-col :span="6">-->
    ...
    <div class="un-handle-layout">
      <div class="layout-title">Todo</div>
      <div class="un-handle-content">
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Unpaid Orders</span>
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Orders Receipt Pending </span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
        <el-row :gutter="20">
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Orders Pending Shipment</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">New Out-of-Stock Notifications</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
          <el-col :span="8">
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="8">
            <div class="un-handle-item">
              <span class="font-medium">Ad spaces will expire soon</span>
              <span style="float: right" class="color-danger">(10)</span>
            </div>
          </el-col>
        </el-row>
  ...
  export default {
    ...
    data() {
      return {
        ...
        labelMap: {'orderCount': '订单数量', 'orderAmount': 'Order Amount'}},
        chartData: {
          columns: [],
          rows: []
        },
