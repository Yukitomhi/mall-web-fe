  ...
  <div class="detail-container">
    <el-card shadow="never">
      ...
      <el-table
        ...
        <el-table-column label="Product Price/Product Code" width="180" align="center">
          <template slot-scope="scope">
            <span class="font-small">Price：￥{{scope.row.productRealPrice}}</span><br>
            <span class="font-small">Code：NO.{{scope.row.productId}}</span>
          </template>
        </el-table-column>
        <el-table-column label="Attribution" width="180" align="center">
          <template slot-scope="scope">{{scope.row.productAttr}}</template>
        </el-table-column>
        <el-table-column label="Count" width="100" align="center">
          <template slot-scope="scope">{{scope.row.productCount}}</template>
        </el-table-column>
        <el-table-column label="Sub Total" width="100" align="center">
    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Phone</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.returnPhone}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Reason</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.reason}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Description</el-col>
          <el-col class="form-border font-small" :span="18">{{orderReturnApply.description}}</el-col>
        </el-row>
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:100px;line-height:80px">Proof image
          </el-col>
      ...
      <div class="form-container-border">
        ...
        <!--</el-row>-->
        <!--<el-row>-->
        <!--  <el-col class="form-border form-left-bg font-small" :span="6">Recipient Name</el-col>-->
      ...
      <div class="form-container-border" v-show="orderReturnApply.status!==0">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Handler Man</el-col>
        ...
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Comment</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===2">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6">Recipient</el-col>
      ...
      <div class="form-container-border" v-show="orderReturnApply.status===0">
        <el-row>
          <el-col class="form-border form-left-bg font-small" :span="6" style="height:52px;line-height:32px">Comment</el-col>
      ...
      <div style="margin-top:15px;text-align: center" v-show="orderReturnApply.status===0">
        <el-button type="primary" size="small" @click="handleUpdateStatus(1)">Agree</el-button>
        <el-button type="danger" size="small" @click="handleUpdateStatus(3)">Refuse</el-button>
      </div>
